          ...
          if (response.status === 200) {
            ...
            if (deviceId === 16065434) {
              this.historys.forEach((item) => {
                item.e1 = new bigdecimal.BigDecimal((parseFloat(`${item.e9}.${prefixInteger(item.e10)}`) * 9.9 - 1700).toString()).setScale(2, 5).toString();
                item.e2 = new bigdecimal.BigDecimal((parseFloat(`${item.e11}.${prefixInteger(item.e12)}`) * 9.9 - 2600).toString()).setScale(2, 5).toString();
                item.e3 = new bigdecimal.BigDecimal((parseFloat(`${item.e13}.${prefixInteger(item.e14)}`) * 9.9 - 1800).toString()).setScale(2, 5).toString();
                item.e4 = new bigdecimal.BigDecimal((parseFloat(`${item.e15}.${prefixInteger(item.e16)}`) * 9.9 - 330).toString()).setScale(2, 5).toString();
              });
            } else {
              this.historys.forEach((item) => {
