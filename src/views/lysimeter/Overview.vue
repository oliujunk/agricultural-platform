      ...
      this.$http
        ...
        .then((response) => {
          ...
          if (data && data.length > 0) {
            ...
            this.fisrtWeight[0] = new bigdecimal.BigDecimal((parseFloat(this.fisrtWeight[0]) * 9.9).toString()).setScale(2, 5);
            this.fisrtWeight[1] = new bigdecimal.BigDecimal((parseFloat(this.fisrtWeight[1]) * 9.9).toString()).setScale(2, 5);
            this.fisrtWeight[2] = new bigdecimal.BigDecimal((parseFloat(this.fisrtWeight[2]) * 9.9).toString()).setScale(2, 5);
            this.fisrtWeight[3] = new bigdecimal.BigDecimal((parseFloat(this.fisrtWeight[3]) * 9.9).toString()).setScale(2, 5);
            ...
            this.backTotalWeight[0] = new bigdecimal.BigDecimal((parseFloat(this.backTotalWeight[0]) * 9.9).toString()).setScale(2, 5);
            this.backTotalWeight[1] = new bigdecimal.BigDecimal((parseFloat(this.backTotalWeight[1]) * 9.9).toString()).setScale(2, 5);
            this.backTotalWeight[2] = new bigdecimal.BigDecimal((parseFloat(this.backTotalWeight[2]) * 9.9).toString()).setScale(2, 5);
            this.backTotalWeight[3] = new bigdecimal.BigDecimal((parseFloat(this.backTotalWeight[3]) * 9.9).toString()).setScale(2, 5);
          ...
          if (response.data) {
            ...
            for (let i = 0; i < 4; i += 1) {
              ...
              if (this.weight[4 + i] === '------') {
                ...
                if (i === 0) {
                  this.totalWeight[i] = new bigdecimal.BigDecimal((parseFloat(this.weight[4 + i]) * 9.9).toString()).setScale(2, 5);
                } else if (i === 1) {
                  this.totalWeight[i] = new bigdecimal.BigDecimal(((parseFloat(this.weight[4 + i])) * 9.9).toString()).setScale(2, 5);
                } else if (i === 2) {
                  this.totalWeight[i] = new bigdecimal.BigDecimal(((parseFloat(this.weight[4 + i])) * 9.9).toString()).setScale(2, 5);
